...
namespace Aden.Util.Common
{
    ...
    public static class DynamicQueryable
    {
        ...
        public static IQueryable SelectMany(this IQueryable source, string selector, string resultsSelector, params object[] values)
        {
            ...
            ParameterExpression[] parameters = new ParameterExpression[] { Expression.Parameter(source.ElementType, "outer"), Expression.Parameter(resultType, "inner") };

            LambdaExpression resultsSelectorLambda = DynamicExpression.ParseLambda(parameters, null, resultsSelector, values);

            // Create the new query 
            return source.Provider.CreateQuery(Expression.Call(typeof(Queryable), "SelectMany",
                new Type[] { source.ElementType, resultType, resultsSelectorLambda.Body.Type }, source.Expression, Expression.Quote(lambda),
        ...
        public static System.Collections.IEnumerable GetList(this Type type)
        {
        ...
        public static IQueryable GroupJoin(this IQueryable outer, IEnumerable inner, string outerKeySelector, string innerKeySelector, string resultSelector, params object[] values)
        {
            ...
            var groupParameter = Expression.Parameter(typeof(IEnumerable<>).MakeGenericType(innerElementType), "group");

            var outerLambda = DynamicExpression.ParseLambda(new[] { outerParameter }, null, outerKeySelector, values);
            var innerLambda = DynamicExpression.ParseLambda(new[] { innerParameter }, outerLambda.Body.Type, innerKeySelector, values);
            var resultLambda = DynamicExpression.ParseLambda(new[] { outerParameter, groupParameter }, null, resultSelector, values);
            ...
            return outer.Provider.CreateQuery(Expression.Call(typeof(Queryable), "GroupJoin",
                    ...
                    outer.Expression, Expression.Constant(inner), Expression.Quote(outerLambda), Expression.Quote(innerLambda),
        ...
        public static object DefaultIfEmpty(this IQueryable source)
        {
            ...
            Expression.Call(typeof(Queryable), "DefaultIfEmpty", new Type[] { source.ElementType }, source.Expression));
        }
    }
...
#pragma warning restore 0219
        ...
        Expression ParseMemberAccess(Type type, Expression instance)
        {
            ...
            else
            {
                ...
                {
                  System.Data.DataColumn col = new System.Data.DataColumn("qty1", typeof(double));
                  ParameterExpression datarow = Expression.Parameter(typeof(System.Data.DataRow), "datarow");
                   MethodCallExpression expr = datarow.ToExpression(col);
                  return Expression.Lambda(expr, new ParameterExpression[] { datarow });
                }
                */
        ...
        Expression ParseAggregate(Expression instance, Type elementType, string methodName, int errorPos)
        {
            ...
            Type[] typeArgs;
            if (signature != null && (signature.Name == "Min" || signature.Name == "Max"))
            {
