...
namespace Aden.Util.Net
{
    public class HttpHelper
    {
        ...
        {
            return Request(url, string.Empty, string.Empty, string.Empty, requestData, Encoding.UTF8, RequestType.POST);
        }
        ...
        {
            return Request(url, string.Empty, string.Empty, string.Empty, requestData, encoding, RequestType.POST);
        }
        ...
        {
            return Request(url, string.Empty, string.Empty, string.Empty, string.Empty, Encoding.UTF8, RequestType.GET);
        }
        ...
        {
            return Request(url, string.Empty, string.Empty, string.Empty, string.Empty, encoding, RequestType.GET);
        }
        ...
        public string Request(string url, string domain, string userName, string password, string requestData,
            Encoding encoding, RequestType type)
        {
            ...
            else request.Method = RequestType.GET.ToString();
